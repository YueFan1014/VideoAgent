...
def main(args):
    ...
    test_frame = frames[0].numpy()
    print(test_frame.shape)
    cv2.imwrite("test_frame.jpg", cv2.cvtColor(test_frame, cv2.COLOR_BGR2RGB))
...
if __name__ == '__main__':
    ...
    #parser.add_argument('--video-path', default='/home/yue/data/mount/fillipo/Datasets/Ego4d/v1/full_scale/0a3dc289-557f-4121-9bc7-521a2b5d3bb8.mp4', type=str, help='video path')
